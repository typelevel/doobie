...
#-scalaz
    ...
    case class  UpdateAsciiStream(a: Int, b: InputStream, c: Long) extends ResultSetOp[Unit] {
    ...
    case class  UpdateAsciiStream2(a: String, b: InputStream) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateAsciiStream(a, b))
    }
    ...
    case class  UpdateBinaryStream1(a: String, b: InputStream) extends ResultSetOp[Unit] {
    ...
    case class  UpdateBinaryStream5(a: Int, b: InputStream, c: Long) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateBinaryStream(a, b, c))
    }
    ...
    case class  UpdateBlob4(a: String, b: Blob) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateBlob(a, b))
    }
    ...
    case class  UpdateCharacterStream2(a: String, b: Reader) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateCharacterStream(a, b))
    }
    case class  UpdateCharacterStream3(a: Int, b: Reader) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateCharacterStream(a, b))
    }
    ...
    case class  UpdateClob5(a: Int, b: Reader, c: Long) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateClob(a, b, c))
    }
    ...
    case class  UpdateObject1(a: Int, b: Object, c: SQLType) extends ResultSetOp[Unit] {
    ...
    case class  UpdateObject4(a: String, b: Object) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateObject(a, b))
    }
    ...
    case class  UpdateObject7(a: Int, b: Object, c: Int) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateObject(a, b, c))
    }
  ...
  def updateAsciiStream(a: String, b: InputStream): ResultSetIO[Unit] =
    F.liftF(UpdateAsciiStream2(a, b))
