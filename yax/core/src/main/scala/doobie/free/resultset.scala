...
#-scalaz
    ...
    case class  GetTimestamp3(a: Int) extends ResultSetOp[Timestamp] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.getTimestamp(a))
    }
    ...
    case class  UpdateAsciiStream(a: Int, b: InputStream, c: Int) extends ResultSetOp[Unit] {
    ...
    case class  UpdateAsciiStream5(a: Int, b: InputStream) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateAsciiStream(a, b))
    }
    ...
    case class  UpdateBinaryStream(a: String, b: InputStream, c: Int) extends ResultSetOp[Unit] {
    ...
    case class  UpdateCharacterStream1(a: String, b: Reader) extends ResultSetOp[Unit] {
    ...
    case class  UpdateCharacterStream5(a: Int, b: Reader, c: Int) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateCharacterStream(a, b, c))
    }
    ...
    case class  UpdateClob3(a: Int, b: Clob) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateClob(a, b))
    }
    ...
    case class  UpdateNClob2(a: String, b: Reader) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateNClob(a, b))
    }
    case class  UpdateNClob3(a: Int, b: NClob) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateNClob(a, b))
    }
    ...
    case class  UpdateObject2(a: String, b: Object, c: SQLType, d: Int) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateObject(a, b, c, d))
    }
    case class  UpdateObject3(a: Int, b: Object, c: SQLType, d: Int) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateObject(a, b, c, d))
    }
    case class  UpdateObject4(a: Int, b: Object, c: Int) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateObject(a, b, c))
    }
    case class  UpdateObject5(a: String, b: Object, c: SQLType) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateObject(a, b, c))
    }
    case class  UpdateObject6(a: Int, b: Object) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateObject(a, b))
    }
    case class  UpdateObject7(a: Int, b: Object, c: SQLType) extends ResultSetOp[Unit] {
      override def defaultTransK[M[_]: Monad: Catchable: Capture] = primitive(_.updateObject(a, b, c))
    }
...
#+fs2
  implicit val CatchableResultSetIO: Catchable[ResultSetIO] =
    new Catchable[ResultSetIO] {
      ...
      def flatMap[A, B](a: ResultSetIO[A])(f: A => ResultSetIO[B]): ResultSetIO[B] = a.flatMap(f)
      def attempt[A](f: ResultSetIO[A]): ResultSetIO[Throwable \/ A] = resultset.attempt(f)
      def fail[A](err: Throwable): ResultSetIO[A] = resultset.delay(throw err)
    }
#-fs2
#-cats
  ...
  def updateAsciiStream(a: Int, b: InputStream): ResultSetIO[Unit] =
    F.liftF(UpdateAsciiStream5(a, b))
  ...
  def updateBinaryStream(a: String, b: InputStream): ResultSetIO[Unit] =
    F.liftF(UpdateBinaryStream5(a, b))
  ...
  def updateCharacterStream(a: String, b: Reader): ResultSetIO[Unit] =
    F.liftF(UpdateCharacterStream1(a, b))

  /** 
   * @group Constructors (Primitives)
   */
  def updateCharacterStream(a: Int, b: Reader): ResultSetIO[Unit] =
    F.liftF(UpdateCharacterStream2(a, b))
  ...
  def updateClob(a: Int, b: Reader, c: Long): ResultSetIO[Unit] =
    F.liftF(UpdateClob4(a, b, c))

  /** 
   * @group Constructors (Primitives)
   */
  def updateClob(a: String, b: Clob): ResultSetIO[Unit] =
    F.liftF(UpdateClob5(a, b))
