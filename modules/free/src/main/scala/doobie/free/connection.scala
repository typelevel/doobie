...
object connection { module =>
  ...
  // ConnectionIO is a Logger
  implicit val LoggerConnectionIO: io.chrisdavenport.log4cats.Logger[ConnectionIO] =
    new io.chrisdavenport.log4cats.Logger[ConnectionIO] {
