...
lazy val doobie = project.in(file("."))
  ...
  .dependsOn(core, example, postgres, h2, hikari, specs2, refined, docs, bench)
  .aggregate(core, example, postgres, h2, hikari, specs2, refined, docs, bench)
...
lazy val refined = project.in(file("contrib/refined"))
